# Ultroid - UserBot
# Copyright (C) 2021-2023 Pamerdong
#
# This file is a part of < https://github.com/Pamerdong/Ultroid/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/Pamerdong/Ultroid/blob/main/LICENSE/>.
            ...
            if plug in HELP["Official"]:
                ...
                try:
                    ...
                    if not file:
                        ...
                        text = f"`{plug}` Plugins tidak valid!"
                        best_match = None
                    ...
                    output = f"**Command** `{plug}` **Ada di plugins** - `{file}`\n"
