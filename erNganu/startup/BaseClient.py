...
class ErUbotClient(TelegramClient):
    ...
    async def start_client(self, **kwargs):
        ...
        if self.me.bot:
            ...
            me = self.full_name
        if self._log_at:
            self.logger.info(f"Logging sebagai {me}")
    ...
    async def fast_uploader(self, file, **kwargs):
        ...
        from erNganu.fns.FastTelethon import upload_file
        from erNganu.fns.helper import progress
    ...
    async def fast_downloader(self, file, **kwargs):
        ...
        from erNganu.fns.FastTelethon import download_file
        from erNganu.fns.helper import progress
