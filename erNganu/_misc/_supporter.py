...
from erNganu._misc._decorators import compile_pattern, erubot_cmd
...
ALIVE_NAME = eruser_bot.me.first_name
BOTLOG_CHATID = BOTLOG = udB.get_key("LOG_CHANNEL")


bot = borg = catub = friday = eruser_bot
catub.cat_cmd = erubot_cmd
