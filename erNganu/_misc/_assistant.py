...
from .. import LOGS, asst, udB, eruser_bot
from ..fns.admins import admin_check
from . import append_or_update, owner_and_sudos

OWNER = eruser_bot.full_name

MSG = f"""
**Er - UserBot**
➖➖➖➖➖➖➖➖➖➖
**Owner**: [{OWNER}](tg://user?id={eruser_bot.uid})
**Support**: @pamerdong
➖➖➖➖➖➖➖➖➖➖
"""
...
def callback(data=None, from_users=[], admins=False, owner=False, **kwargs):
    ...
    if "me" in from_users:
        ...
        from_users.append(eruser_bot.uid)
            ...
            if owner and event.sender_id not in owner_and_sudos():
                res = [
                    await event.builder.article(
                        title="Er Userbot",
                        url="https://t.me/chakszzz",
                        description="(c) chakszzz",
                        text=MSG,
