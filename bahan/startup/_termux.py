...
{Fore.BLACK}{Back.WHITE} _____________ 
 Er Nganu KONT KONT KONT KONT KONT KONT KONT KONT KONT
{Style.RESET_ALL}
{Fore.GREEN}- Sudah ya
{Fore.RESET}
...
if inp in ["yes", "y"]:
    print(f"{Fore.GREEN}*Mengucapkan Bim Salabim*")
...
if not path.exists(".env"):
    print(with_header("#Sekalian bikin config vars nya ? [y/N] "))
    ask_make_env()

print(with_header(f"\n{Fore.GREEN}Sudah selesai semua! 🥳"))
sleep(0.2)
print(f"Gunakan 'bash startup' untuk start deploy Er Userbot.{Fore.RESET}")
sleep(0.5)
print(
